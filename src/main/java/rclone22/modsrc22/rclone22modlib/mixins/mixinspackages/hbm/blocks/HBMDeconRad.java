...
@Mixin(value = BlockDeconRad.class, remap = false)
@Implements(@Interface(iface = IRadResistantBlock.class, prefix = "isRadResistant$"))
public abstract class HBMDeconRad extends BlockContainer
{

    @Unique
    private static float rclone22modlib$radRemove;

    public HBMDeconRad(Material materialIn, String s, float rad) {
        super(materialIn);
        this.setUnlocalizedName(s);
        this.setRegistryName(s);
        rclone22modlib$radRemove = rad;
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityDeconRad(rclone22modlib$radRemove);
    }
