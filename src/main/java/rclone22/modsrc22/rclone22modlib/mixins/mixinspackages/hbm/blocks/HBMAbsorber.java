...
public abstract class HBMAbsorber extends Block
{
    ...
    public void updateTick(World world, BlockPos pos, IBlockState state, Random rand) {
        RadiationSavedData.decrementRad(world, pos, rclone22modlib$absorb);
